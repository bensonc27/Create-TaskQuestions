...
The function insertText requires two inputs: inputContent and type. Using the inputContent, the function creates a variable. If the input is a file, then for each file/item, the function inserts a line of text about each item of the file.
